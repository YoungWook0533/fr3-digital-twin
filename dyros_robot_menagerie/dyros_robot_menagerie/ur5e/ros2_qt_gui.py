...
class Ros2QtGui(Node, QWidget):
    def __init__(self):
        ...
        self.setWindowTitle('UR5e Controller GUI')
        ...
        self.joint_list = ["shoulder_pan_joint",
                           "shoulder_lift_joint",
                           "elbow_joint",
                           "wrist_1_joint",
                           "wrist_2_joint",
    ...
    def joint_state_callback(self, msg: JointState):
        for jname, pos in zip(self.joint_list, msg.position[:6]):
            self.joint_edits[jname].setText(f"{pos:.3f}")
