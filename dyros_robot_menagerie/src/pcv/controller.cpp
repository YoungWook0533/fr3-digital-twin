#include "dyros_robot_menagerie/pcv/controller.h"

namespace PCV
{
    void PCVController::configure(const rclcpp::Node::SharedPtr& node)
    {
    ...
    void PCVController::updateState(const MujocoRosSim::VecMap& pos_dict, 
    ...
    MujocoRosSim::CtrlInputMap PCVController::getCtrlInput() const
    {
    ...
    PLUGINLIB_EXPORT_CLASS(PCV::PCVController, MujocoRosSim::ControllerInterface)
} // namespace PCV