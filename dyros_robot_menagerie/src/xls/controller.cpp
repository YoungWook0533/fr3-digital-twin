#include "dyros_robot_menagerie/xls/controller.h"
...
namespace XLS
{
    ...
    void XLSController::updateState(const MujocoRosSim::VecMap& pos_dict, 
    ...
    MujocoRosSim::CtrlInputMap XLSController::getCtrlInput() const
    {
    ...
    PLUGINLIB_EXPORT_CLASS(XLS::XLSController, MujocoRosSim::ControllerInterface)
} // namespace XLS